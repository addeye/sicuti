      ...
      <aside class="control-sidebar control-sidebar-dark">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="control-sidebar-home-tab">
            ...
            <ul class="control-sidebar-menu">
              <li>
                <a href="#">
                  ...
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">Name Private</h4>
                    <p>Pacitan, . . </p>
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  ...
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">Phone Number</h4>
                    <p>+62</p>
                  </div>
                </a>
              </li>
              ...
              <li>
                <a href="#">
                  ...
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">Personal Website</h4>
                    <p>#</p>
                  </div>
                </a>
              </li>
            ...
            <h3 class="control-sidebar-heading">Lain-Lain</h3>
            <ul class="control-sidebar-menu">
              <li>
                <a href="#">
          ...
          <p>
         Aplikasi ini di gunakan untuk mempermudah pengajuan cuti pegawai pn pcitan :
          </p>
          <ul class="control-sidebar-menu">
              <li>
                <a href="#">
                  <i class="menu-icon fa fa-whatsapp bg-red"></i>
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">+62</h4>
              ...
              <li>
                <a href="#">
                  ...
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">+62</h4>
                    <p>Sms atau Telepon</p>
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  <i class="menu-icon fa fa-comment-o bg-green"></i>
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">+62</h4>
                    <p >Telegram</p>
                  </div>
              ...
              <li>
                <a href="mailto:hakkobiorichard@gmail.com">
                  <i class="menu-icon fa fa-envelope-o bg-light-blue"></i>
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">Email</h4>
