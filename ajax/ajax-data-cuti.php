...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
                     <a href="index.php?page=detail-cuti&id='.$row['kode'].'"  data-toggle="tooltip" title="View Detail" class="btn btn-sm btn-success"> <i class="glyphicon glyphicon-search"></i> </a>
                     <a href="index.php?page=edit-cuti&id='.$row['kode'].'"  data-toggle="tooltip" title="Edit" class="btn btn-sm btn-primary"> <i class="glyphicon glyphicon-edit"></i> </a>
				     <a href="index.php?page=cuti&aksi=delete&id='.$row['kode'].'&nik='.$row['nik'].'"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nik'].'?\')" class="btn btn-sm btn-danger"> <i class="glyphicon glyphicon-trash"> </i> </a>
	                 </center></td>';
