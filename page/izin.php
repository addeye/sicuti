    ...
    <section class="col-lg-12 connectedSortable">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <a href="index.php?page=input-izin" class="btn btn-sm btn-primary <?=$_SESSION['level'] == 1?'hidden':''?> "><i class="fa fa-plus"></i> Buat Izin</a>
          <!-- <a href="izin_exportxls.php" class="btn btn-sm btn-success"><i class="fa fa-file"></i> Export Excel</a> -->
          </div>
        </div><!-- /.box-header -->
        <div class="box-body">
          <table id="lookup" class="table table-bordered table-hover">
            ...
            <tbody>
            <?php $no = 0; while ($data = mysqli_fetch_array($tampil)) {
    $no++; ?>
              <tr>
                <td><?=$data['kode']?></td>
                <td><?=$data['nik']?></td>
